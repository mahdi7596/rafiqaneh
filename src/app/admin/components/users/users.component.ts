...
export class UsersComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['id', 'firstName', 'lastName', 'mobileNumber', 'nationalCode',
    'birthDate', 'createdAt', 'province', 'mobileConfirmed'];
  ...
  loadUsers() {
    let q = environment.apiUrl + '/api/admin/users?skip=' + this.skip + '&take=' + this.take;
  ...
  downloadCsv(e: Event) {
    e.stopPropagation();
    this.spinner.show();
    this.http.get('/api/admin/users/export-csv',
      {
